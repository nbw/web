...
1. **Established explicitly beforehand.**
    ...
    + kyou, otoko no hito <span class="en">ga</span> gakkou ni kimashita. kare <span class="en">ha</span> piza wo mottekimashita.
...
2. **Established by inference; an assummed context**
    ...
    + oishikattakeredomo, dezaato <span class="en">wa</span> sukoshi takakattadesu.
...
The particle が has a few users, but they're all related to the subject. Here's a quick list before going into more detail:
...
3. Used as the subject in subordinate clauses (dependent clauses)

4. The direct object in conditional phrases (が instead of を)
...
2. **Emphasizes a subject; the answer to a question**

    + 雨<span class="jp">が</span>降っています。
    + ame <span class="en">ga</span> hutteimasu.
    + It is raining.
...
3. **The subject in a subordinate clause (dependent clause)**

    + お兄さん<span class="jp">が</span>財布を忘れたので、行けません。
    + Onisan <span class="en">ga</span> saihu wo wasuretanode, ikemasen.
...
4. **Direct object in conditional phrases (が instead of を)**
...
1. **Answering a question**
    ...
    Probably the most interesting differences between the two particles is **"は directs the hearer's attention to what follows [afterwards]." Whereas が directs the "hearer's attention to what precedes."**
    ...
    **Example #1:**
    ...
    + mikan <span class="en">wa</span> oishiitomoimasu.
    ...
    **Example #2:**
    ...
    + Tanakasan <span class="en">wa</span> atarashii kuruma wo kaimashita.
    + Tanaka bought a new car.

    In the case of は, the question being answered might be _"What did Tanaka buy?"_ Here the we can assume that Tanaka has already been established, now we want to know more about them.
...
2. **Subordinate (dependent) clauses**
    ...
    + maikeru <span class="en">ha</span> keeki wo tsukuttanode, osara to hooku wo mottekita.
    ...
    + maikeru <span class="en">ga</span> keeki wo tsukuttanode, osara to hooku wo mottekita.

    The likely interpretation is the speaker is the subject. So the sentence translates to:
...
The difference between が and は is subtle. They're both related to the topic/subject, but differ with regards to emphasis.
...
I hope this post been helpful. If it has, please share it around or leave a comment. Many thanks to Naomi Hanaoko McGloin for her book.
